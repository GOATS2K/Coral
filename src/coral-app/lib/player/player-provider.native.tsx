...
export interface NativePlayerContext {
  playerA: AudioPlayer;
  playerB: AudioPlayer;
...
const PlayerContext = createContext<NativePlayerContext | null>(null);
...
export function PlayerProvider({ children }: { children: ReactNode }) {
  ...
  const playersRef = useRef<NativePlayerContext>({
    playerA,
    playerB,
    playerATrackIdRef,
    playerBTrackIdRef,
...
export function useNativePlayerContext() {
  const context = useContext(PlayerContext);
  if (!context) {
    throw new Error('useNativePlayerContext must be used within NativePlayerProvider');
  }
  return context;
}
